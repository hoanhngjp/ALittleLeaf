        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdrsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AdrsFullname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AdrsAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AdrsPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AdrsIsDefault = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressList", x => x.AdrsId);
                    table.ForeignKey(
                        name: "FK_AddressList_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bill_AddressList_AddressId",
